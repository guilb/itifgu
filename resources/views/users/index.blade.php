            ...
            <div class="clearfix div-row row">
              ...
              <div class="col-xs-12 col-md-4 actions" id="buttons">
                ...
                @if (finishedOrders($user) != "0")
                    <a type="button" href="{{ route('invoice.store', $user) }}" class="btn btn-primary btn-sm float-right mr-2" data-toggle="tooltip" title="@lang('Facturer les commande de') {{ $user->name }}"><i class="fas fa-euro-sign fa-lg"></i></a>
                @endif
              </div>
            </div>
          @endforeach
