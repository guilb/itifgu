...
Product::create(['name'=>'Voilage','category_id'=>'2','price_display'=>'4€/m2','price_value'=>'4','delay'=>'J+3', 'vat'=>'20', ]);
Product::create(['name'=>'Rideaux simples','category_id'=>'2','price_display'=>'6€/m2','price_value'=>'6','delay'=>'J+3', 'vat'=>'20', ]);
Product::create(['name'=>'Rideaux doubles','category_id'=>'2','price_display'=>'8€/m2','price_value'=>'8','delay'=>'J+3', 'vat'=>'20', ]);
Product::create(['name'=>'Tapis','category_id'=>'2','price_display'=>'14€/m2','price_value'=>'14','delay'=>'J+3', 'vat'=>'20', ]);
Product::create(['name'=>'Articles en plume sur devis','category_id'=>'2','price_display'=>'devis','price_value'=>'0','delay'=>'J+3', 'vat'=>'20', ]);
...
Product::create(['name'=>'Ourlet Pantalon','category_id'=>'4','price_display'=>'à partir de 8,84€','price_value'=>'8.84','delay'=>'J+5', 'vat'=>'20', ]);
Product::create(['name'=>'Ourlet Jupe','category_id'=>'4','price_display'=>'à partir de 13,42€','price_value'=>'13.42','delay'=>'J+5', 'vat'=>'20', ]);
Product::create(['name'=>'Fermeture éclair','category_id'=>'4','price_display'=>'à partir de 11,11€','price_value'=>'11.11','delay'=>'J+5', 'vat'=>'20', ]);
...
Product::create(['name'=>'<20mn','category_id'=>'6','price_display'=>'à partir de 7€','price_value'=>'7','delay'=>'SUR RDV', 'vat'=>'20', ]);
Product::create(['name'=>'<30mn','category_id'=>'6','price_display'=>'à partir de 10€','price_value'=>'10','delay'=>'SUR RDV', 'vat'=>'20', ]);
Product::create(['name'=>'Selon les bons de commande','category_id'=>'7','price_display'=>'selon demande','price_value'=>'0','delay'=>'CHAQUE SEMAINE', 'vat'=>'20', ]);
}
}
